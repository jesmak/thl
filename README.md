...
2. Search for THL disease statistics in HACS and install with type integration
...
2. Copy custom_components/thl folder to your Home Assistant installation's config/custom_components folder.
3. Restart Home Assistant
...
| disease  | enum   | **Required** | Disease selection                                                     |         |


### State attributes

As the state, this integration returns last week's case count for the whole country. There are also extra attributes
...
| amount_last_week     | int    | Case count for last week                                |
| amount_two_weeks_ago | int    | Case count two weeks ago                                |
...
[thl-card](https://github.com/jesmak/thl-card).